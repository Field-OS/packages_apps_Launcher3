...
import com.android.launcher3.ProtonPlusLauncher;
import com.android.launcher3.ProtonPlusLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        ProtonPlusLauncher launcher = (ProtonPlusLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        ProtonPlusLauncherModelDelegate delegate = (ProtonPlusLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        ProtonPlusLauncher launcher = (ProtonPlusLauncher) ActivityContext.lookupContext(getContext());

...
public class ProtonPlusLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "ProtonPlusLauncherModelDelegate";
    ...
    public ProtonPlusLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
